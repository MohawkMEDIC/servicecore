...
namespace MARC.HI.EHRS.SVC.Messaging.FHIR.Util
{
    ...
    public static class StructureDefinitionUtil
    {
        ...
        public static StructureDefinition GetStructureDefinition(this Type me, bool isProfile = false)
        {
            ...
            if (isProfile)
                baseStructureDefn = new Uri(Reference.CreateResourceReference<StructureDefinition>(me.GetStructureDefinition(false), WebOperationContext.Current.IncomingRequest.UriTemplateMatch.BaseUri).ReferenceUrl, UriKind.Relative);
