...
if exist "C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\MSBuild\15.0\Bin\MSBuild.exe" (
	...
	"C:\Program Files (x86)\Microsoft Visual Studio\2017\Enterprise\MSBuild\15.0\Bin\MSBuild.exe" ..\ServiceCore.sln /t:clean /t:restore /t:rebuild /p:configuration=Debug /m
) else ( 
	if exist "C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\MSBuild\15.0\Bin\MSBuild.exe" (
		echo will use VS 2017 build tools
		"C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\MSBuild\15.0\Bin\MSBuild.exe" ..\ServiceCore.sln /t:clean /t:restore /t:rebuild /p:configuration=Debug /m
	)
	else (
