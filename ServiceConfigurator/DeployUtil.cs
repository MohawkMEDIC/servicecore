    ...
    public static class DeployUtil
    {
        ...
        public static void Deploy(StringCollection deploymentList, Dictionary<String, StringCollection> options)
        {
            ...
            try
            {
                ...
                progress.Show();
                int i = 0;
                foreach (var pnl in ConfigurationApplicationContext.s_configurationPanels.FindAll(o => o is IAutoDeployConfigurationPanel && deploymentList.Contains(o.Name)))
                {
                    ...
                    (pnl as IAutoDeployConfigurationPanel).PrepareConfigure(configurationDom, options);
                ...
                foreach (var pnl in ConfigurationApplicationContext.s_configurationPanels.FindAll(o => o is IAlwaysDeployedConfigurationPanel))
                {
                     pnl.Configure(configurationDom);
                }
